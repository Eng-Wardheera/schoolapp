...
from app.modal import AcademicYear, Branch, Class, ClassLevel, Exam, ExamSubject, ExamTimetable, Parent, School, Section, Student, StudentFeeCollection, Subject, Teacher, TeacherAssignment, Term, UserRole
